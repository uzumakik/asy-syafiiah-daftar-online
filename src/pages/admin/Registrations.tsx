...
import { CheckCircle, XCircle, Search, Eye, Check, X } from 'lucide-react';
...
const Registrations = () => {
  ...
  useEffect(() => {
    ...
    if (adminLoggedIn) {
      ...
      setFilteredRegistrations(storedRegistrations);
    }
  ...
  const approveRegistration = (id: number) => {
    ...
    const updated = filteredRegistrations.map(reg => 
      reg.id === id ? { ...reg, status: 'Diterima' } : reg
    );
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1">
        <div className="p-8">
          <h1 className="text-3xl font-bold text-school-primary mb-8">Semua Pendaftar</h1>
          
          <div className="bg-white p-6 rounded-lg shadow mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-school-primary mb-4 md:mb-0">Daftar Pendaftar</h2>
            ...
            {filteredRegistrations.length > 0 ? (
              <Table>
                <TableCaption>Daftar pendaftar siswa baru SDIT Asy-Syafiiah</TableCaption>
                <TableHeader>
                  <TableRow>
              ...
              <div className="text-center py-8 text-gray-500">
                {searchTerm ? 'Tidak ada hasil yang sesuai dengan pencarian' : 'Belum ada pendaftaran'}
              </div>
            )}
          </div>
        </div>
            ...
            <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {selectedRegistration.status === 'Menunggu Verifikasi' && (
